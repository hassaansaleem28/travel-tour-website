    ...
    <main className="font-[Poppins]">
      <section className="h-[100vh] md:mb-30 mb-15 lg:mb-30">
        ...
        <Hero
          ...
          textStyle="lg:text-3xl lg:ml-25 ml-15 md:ml-27 lg:text-center mb-10 text-2xl md:text-2xl md:tracking-wide lg:tracking-wider text-center absolute left-11 lg:absolute lg:left-25 text-stone-100 font-[500] lg:mb-8 md:mb-7 mb-5 md:mt-3 lg:mt-4"
          imageUrl={img}
          ...
          route="/"
          headingStyle="lg:text-7xl md:ml-3 text-[3rem] text-center ml-27 lg:ml-8 mb-3 md:text-6xl font-extrabold text-stone-100"
          btnStyle="bg-stone-100 px-7 tracking-[2px] text-xl font-[500] hover:text-slate-100 absolute top-60 lg:absolute lg:top-40 md:top-35 left-2 hover:bg-teal-500 transition-all duration-0.3 ease-in-out rounded-md py-3 ml-42 md:ml-65 lg:ml-90"
          btnName="Travel Plan"
        />
      </section>
