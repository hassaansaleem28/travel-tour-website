...
function Navbar() {
  ...
  return (
    <div className="flex items-center justify-center">
      <nav className="flex top-4 left-1/2 transform -translate-x-1/2 p-2 lg:gap-50 shadow-lg text-2xl bg-stone-100 rounded-2xl  lg:w-[76rem] md:w-[60rem] md:gap-20 z-9999 fixed gap-[11rem]">
        <Logo />
